...
#----------- copied from here: https://github.com/ucsbieee/py65/blob/main/py65/monitor.py
# to show changes made by the rs65 project for benchmarking
...
class Monitor(cmd.Cmd):
    ...
    def _run(self, stopcodes):
        ...
        if not breakpoints:
            # ------------ Changed for rs65 project added in timing code ----------
            # Timing python code:
...
def main(args=None):
    # --------- Changed for rs65 project. Original line was: c = Monitor(putc_addr=None, getc_addr=None) --------------
    c = Monitor(putc_addr=None, getc_addr=None)
